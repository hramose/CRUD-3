...
use Sone\CRUD\PanelTraits\CrudButton;
...
class CrudPanelButtonsTest extends BaseCrudPanelTest
{
    ...
    public function testAddButtonFromView()
    {
        ...
        $soneButtonViewPackage = 'vendor.sone.crud.buttons.';
        ...
        $this->assertEquals($soneButtonViewPackage.$viewName, $actualButton->content);
        $this->assertEquals($expectedButton->stack, $actualButton->stack);
    }
