...
class Publish extends Command
{
     ...
     * @var string
     */
    protected $name = 'sone:crud:publish';
     ...
     * @var string
     */
    protected $signature = 'sone:crud:publish
     ...
     * @var string
     */
    protected $description = 'Publishes a Sone view so you can make changes in your project. Please note you won\'t be getting any updates for these files after you publish them - Sone will be using YOUR file, instead of the one in vendor.';

    /**
     * The directory where the views will be published FROM.
     * @var string
     */
    public $sourcePath = 'vendor/sone/crud/src/resources/views/';

    /**
     * The directory where the views will pe published TO.
     * @var string
     */
    public $destinationPath = 'resources/views/vendor/sone/crud/';
