...
trait CrudUsageStats
{
    ...
    /**
     * Send usage statistics to the SoneForLaravel.com website.
    ...
    private function sendUsageStats()
    {
        ...
        $stats = [
            ...
            'SONE_BASE_VERSION' => $_SERVER['SONE_BASE_VERSION'] ?? false,
            'SONE_CRUD_VERSION' => $_SERVER['SONE_CRUD_VERSION'] ?? false,
            'SONE_LICENSE' => config('sone.base.license_code') ?? false,
        ];
