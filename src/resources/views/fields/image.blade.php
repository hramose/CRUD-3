  ...
  <div data-preview="#{{ $field['name'] }}"
    ...
    <div class="btn-group">
        <label class="btn btn-primary btn-file">
            {{ trans('sone::crud.choose_file') }} <input type="file" accept="image/*" id="uploadImage"  @include('crud::inc.field_attributes', ['default_class' => 'hide'])>
...
@if ($crud->checkIfFieldIsFirstOfItsType($field))
    ...
    @push('crud_fields_styles')
        {{-- YOUR CSS HERE --}}
        <link href="{{ asset('vendor/sone/cropper/dist/cropper.min.css') }}" rel="stylesheet" type="text/css" />
        <style>
            .hide {
                display: none;
            }
    ...
    @push('crud_fields_scripts')
        {{-- YOUR JS HERE --}}
        <script src="{{ asset('vendor/sone/cropper/dist/cropper.min.js') }}"></script>
        <script>
