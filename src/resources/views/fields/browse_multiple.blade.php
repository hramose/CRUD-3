...
@if ($crud->checkIfFieldIsFirstOfItsType($field))
    ...
    @push('crud_fields_styles')
        ...
        <link href="{{ asset('vendor/sone/colorbox/example2/colorbox.css') }}" rel="stylesheet" type="text/css"/>
        <style>
    ...
    @push('crud_fields_scripts')
        ...
        <script src="{{ asset('vendor/sone/colorbox/jquery.colorbox-min.js') }}"></script>
            ...
            $(document).on('click', '.popup.browse_{{ $field['name'] }}', function (event) {
                ...
                div.elfinder({
                    ...
                    dialog: {
                        ...
                        modal: true,
                        @if ($multiple)
                        title: '{{ trans('sone::crud.select_files') }}',
                        @else
                        title: '{{ trans('sone::crud.select_file') }}',
                        @endif
                    },
                    resizable: false,
