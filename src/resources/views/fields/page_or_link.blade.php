<!-- PAGE OR LINK field -->
<!-- Used in Sone\MenuCRUD -->

<?php
    $field['options'] = ['page_link' => trans('sone::crud.page_link'), 'internal_link' => trans('sone::crud.internal_link'), 'external_link' => trans('sone::crud.external_link')];
        ...
        <!-- external link input -->
          <div class="page_or_link_value <?php if (!isset($entry) || $entry->type != 'external_link') {
            ...
            <input
                ...
                class="form-control"
                name="link"
                placeholder="{{ trans('sone::crud.page_link_placeholder') }}"
          ...
          <div class="page_or_link_value <?php if (!isset($entry) || $entry->type != 'internal_link') {
            ...
            <input
                ...
                class="form-control"
                name="link"
                placeholder="{{ trans('sone::crud.internal_link_placeholder', ['url', url(config('sone.base.route_prefix').'/page')]) }}"
