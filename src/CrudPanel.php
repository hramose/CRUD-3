...
use Sone\CRUD\PanelTraits\Read;
use Sone\CRUD\PanelTraits\Tabs;
use Sone\CRUD\PanelTraits\Query;
use Sone\CRUD\PanelTraits\Views;
use Sone\CRUD\PanelTraits\Access;
use Sone\CRUD\PanelTraits\Create;
use Sone\CRUD\PanelTraits\Delete;
use Sone\CRUD\PanelTraits\Errors;
use Sone\CRUD\PanelTraits\Fields;
use Sone\CRUD\PanelTraits\Search;
use Sone\CRUD\PanelTraits\Update;
use Sone\CRUD\PanelTraits\AutoSet;
use Sone\CRUD\PanelTraits\Buttons;
use Sone\CRUD\PanelTraits\Columns;
use Sone\CRUD\PanelTraits\Filters;
use Sone\CRUD\PanelTraits\Reorder;
use Sone\CRUD\PanelTraits\AutoFocus;
use Sone\CRUD\PanelTraits\FakeFields;
use Sone\CRUD\PanelTraits\FakeColumns;
use Illuminate\Database\Eloquent\Collection;
use Sone\CRUD\PanelTraits\RequiredFields;
use Sone\CRUD\PanelTraits\ViewsAndRestoresRevisions;
...
class CrudPanel
{
     ...
     * - $this->crud->setRoute(config('sone.base.route_prefix').'/article')
     * - $this->crud->setRouteName(config('sone.base.route_prefix').'.article')
     * - $this->crud->route = config('sone.base.route_prefix')."/article"
     *
     * @return string
     */
