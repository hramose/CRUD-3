...
trait Read
{
    ...
    */
    ...
    public function getDefaultPageLength()
    {
        ...
        if (config('sone.crud.default_page_length')) {
            return config('sone.crud.default_page_length');
        }
    ...
    public function getPageLengthMenu()
    {
        ...
        if (! $this->page_length_menu) {
            ...
            if (! $this->page_length_menu = config('sone.crud.page_length_menu')) {
                // otherwise set a sensible default
                $this->page_length_menu = [[10, 25, 50, 100, -1], [10, 25, 50, 100, 'sone::crud.all']];
            }
